...
var datetimepickerFactory = function ($) {
    ...
    $.fn.datetimepicker = function (opt, opt2) {
        ...
        createDateTimePicker = function (input) {
            var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect test"></div>'),
            ...
            datetimepicker
                .on('xchange.xdsoft', function (event) {
                    ...
                    xchangeTimer = setTimeout(function () {
                        ...
                        table += '<table class="xdsoft_calendar--table"><thead><tr>';
                ...
                if (options.fixed) {
                    ...
                    if (dateInputHasFixedAncestor && !options.insideParent) {
                        ...
                        if(/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream){
                            console.log('ios top default: ' + verticalPosition);
                            console.log('ios top: ' + windowScrollTop);
                            verticalPosition -= windowScrollTop;
                            console.log('ios top: ' + verticalPosition);
                        } else {
                            if (verticalPosition + datetimepicker.outerHeight() > windowHeight + windowScrollTop) {
                                verticalAnchorEdge = 'bottom';
                                verticalPosition = (windowHeight + windowScrollTop) - dateInputOffset.top;
                                console.log('bottom: ' + verticalPosition);
                            } else {
                                verticalPosition -= windowScrollTop;
                                console.log('top: ' + verticalPosition);
                            }
                        }
                    } else {
